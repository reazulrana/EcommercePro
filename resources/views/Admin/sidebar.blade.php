<div class="nk-sidebar">
    <div class="nk-nav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a href="{{Route('view_category')}}" aria-expanded="false">
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="{{Route('show_product')}}">Show Product</a></li>
            ...
            <li>
                ...
                <a href="{{Route('order_show')}}" aria-expanded="false">
                    <i class="fa fa-first-order"></i><span class="nav-text">Order</span>
                </a>
